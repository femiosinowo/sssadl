<%@ Control Language="C#" AutoEventWireup="true" CodeFile="contactControls.ascx.cs"
...
<asp:Panel runat="server" ID="TrainingRequest" Visible="false">
    ...
    <input id="whichResources" value="TrainingRequest" type="hidden" />
        <label for="SubjectArea" id="contact_option6_topic">Topic of Training<span class="fg-red" title="Required">*</span><br /></h4>
            (Select either a <span id="contact_option6_subject">subject</span> or a <span id="contact_option6_resource">
                resource</span>, or both.)</label></h4>
<%--    <p>
...
<asp:Panel runat="server" ID="PasswordAssistancePanel" Visible="false">
    <h4>
        <label for="Resource" id="contact_option6_topic">For which Resource do you need password assistance?<span class="fg-red" title="Required">*</span><br /></label></h4>
...
<asp:Panel runat="server" ID="RequestAccessPanel" Visible="false">
    <h4>
        <label for="Resource" id="contact_option6_topic">Select the Database you wish to access<span class="fg-red" title="Required">*</span><br /></label></h4>
...
<input id="whichResources" value="ResearchAssistance" type="hidden" />
    <h4>
        <label for="SubjectArea" id="contact_option6_topic">What do you need help with?: <span class="fg-red" title="Required">*</span><br /></h4>

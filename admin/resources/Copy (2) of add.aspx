<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Masters/AdminMain.master" AutoEventWireup="true" CodeFile="Copy (2) of add.aspx.cs" Inherits="admin_users_Default" %>
...
.block {
     ...
     <link rel="stylesheet" href="/admin/framework/css/tabs1.css">
    <script>
        $(function () {
...
Instructions is required" ></asp:TextBox>
 ...
 <div class="container">
  ...
  <div class="well">
    ...
    <a href="javascript:void()" id="btnAdd"><i class="icon-plus-sign-alt"></i> Add Tab</a>
    <br><br>

<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Masters/AdminMain.master" AutoEventWireup="true" CodeFile="incomingdelete.aspx.cs" Inherits="admin_users_Default" ValidateRequest="false" %>
  ...
  <div id="title-bar">
    <h2>
      <span class="favorite-id">
          All Incoming e-Passwords Requests</span> 
...
<div class="grid" id="admin-tools-int-content">
  ...
  <div class="buttons" >
	  <%--	<a href="#" class="btn">Add User</a> --%>
        <asp:LinkButton runat="server" CssClass="btn" ID="AddRequest" Text="New Request" 
           ></asp:LinkButton>
...
<asp:LinkButton runat="server"  ID="ExcelClick" 
     ...
     <a href="javascript:selectAll('ctl00_mainContentCP_AdminUsers')"   >Select All</a> |  <a href="javascript:selectNone('ctl00_mainContentCP_AdminUsers')">Select None</a>
       ...
       <div class="column-5">
       <p></p><asp:Button  runat="server" ID="UpdateListBtnForSubJEPass" 
               Text="Update List" onclick="UpdateListBtnForSubJEPass_Click" 
                /></div>
       </div>
	  ...
	  <caption><h3></h3></caption>
	    ...
	    <tr>
         ...
         Text="Date" CommandName="Sort" CommandArgument="Date" />

            <asp:ImageButton ID="DateImg" CommandArgument="Date" CommandName="Sort" ImageUrl="~/admin/img/asc.png" runat="server" />

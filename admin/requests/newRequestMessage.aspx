<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Masters/AdminMain.master" AutoEventWireup="true" CodeFile="newRequestMessage.aspx.cs" Inherits="admin_users_Default" ValidateRequest="false" %>
      ...
      <label  for="BodyText" >Body Text</label> <br/>
       ...
       <asp:Button CssClass="btn" runat="server" ID="SendBtn" Text="Send" onclick="SendBtn_Click" 
                ></asp:Button>
                 ...
                 <asp:Button CssClass="btn" runat="server" ID="SkipMessage" 
               Text="Skip Message" onclick="SkipMessage_Click"  
                ></asp:Button>

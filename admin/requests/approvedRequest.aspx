<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Masters/AdminMain.master" AutoEventWireup="true" CodeFile="approvedRequest.aspx.cs" Inherits="admin_users_Default" ValidateRequest="false" %>
...
<div class="grid" id="admin-tools-int-content">
   ...
   <asp:HiddenField runat="server" ID="RequestorPIN" />
     <p> <label for="RequestorName">Name </label> <br/>  
      ...
      <div class="container-blue" runat="server" id="appMess" visible="false" ><%=approvedMessage %></div>
      </p>
      ...
      <label  for="RequestApprovedEmailMessageText" >Body Text</label> <br/>
       ...
       <asp:LinkButton CssClass="btn" runat="server" ID="SaveForLater" Text="Save For Later" 
               onclick="SaveForLater_Click" ></asp:LinkButton>
       <asp:Button CssClass="btn" runat="server" ID="Cancel" Visible="false" Text="Cancel" 
               onclick="Cancel_Click" ></asp:Button> 
               <input name="ctl00$mainContentCP$Cancel" class="btn" id="ctl00_mainContentCP_Cancel" type="button" onclick="history.back(-1);" value="Cancel">

...
<div class="grid" id="admin-tools-int-content">
	  ...
	  <asp:Panel runat="server" ID="passwordassistance" Visible="false" >	
       <script>
           $(function () {
               $("#datefrom").datepicker();
           });
     ...
     <table class="table table-bordered table-striped">
	  ...
	  <tbody>
	    <tr>
		  <td headers="header1">Submission Date from</th>
		  <td headers="header2">Submission Date to</td>
 
		  
		</tr>
		<tr>
		  <td headers="header1"><input type="date" id="datefrom" /></th>
		  <td headers="header2"><input type="date" id="dateto"    /></td>

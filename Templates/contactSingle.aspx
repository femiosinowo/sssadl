<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/TwoColumn.master" AutoEventWireup="true" CodeFile="contactSingle.aspx.cs" Inherits="Templates_Content" %>
...
input[type="submit"] {
 ...
 <ux:contact ID="contactForm" runat="server" />
  <cms:FormBlock ID="mainForm" DynamicParameter="ekfrm" runat="server" />

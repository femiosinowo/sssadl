<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/TwoColumn.master" AutoEventWireup="true" EnableEventValidation="false" EnableViewStateMac="false" CodeFile="contactConfirm.aspx.cs" Inherits="Templates_Content" %>
...
<ux:Breadcrumbs ID="uxBreadcrumb" contentID="107"  runat="server" />
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphSecondaryMainContent" runat="Server">
       <a name="MOVEHERE"></a>
  <CMS:ContentBlock ID="mainContent"  DefaultContentID="107"   runat="server" />

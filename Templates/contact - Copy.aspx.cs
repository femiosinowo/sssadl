...
public partial class Templates_Content : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        foreach (var a in contenIdTitles)
        {
            ...
            li.Text = a.Value;
            li.Value = a.Key.ToString();// "option" + i.ToString();
    ...
    protected void contactSelect_SelectedIndexChanged(object sender, EventArgs e)
    {
       // defaultFormID = contactSelect.SelectedValue;

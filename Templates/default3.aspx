<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/TwoColumn.master" AutoEventWireup="true" CodeFile="default3.aspx.cs" Inherits="Templates_Content" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphSecondaryMainContent" runat="Server">
  ...
  <cms:FormBlock IncludeTags="false" DefaultFormID="105" runat="server" ID="formBlk" />
	  <!-- END COLUMN -->

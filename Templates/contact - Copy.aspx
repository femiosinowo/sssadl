<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/TwoColumn.master" AutoEventWireup="true"  CodeFile="contact - Copy.aspx.cs" Inherits="Templates_Content" %>
...
<%--$(function () {
  ...
  <CMS:ContentBlock ID="mainContent" DynamicParameter="id"   runat="server" />
    ...
    <asp:DropDownList runat="server" ID="contactSelect" AutoPostBack="true" OnSelectedIndexChanged="contactSelect_SelectedIndexChanged" ></asp:DropDownList>
